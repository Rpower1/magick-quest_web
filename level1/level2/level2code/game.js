...
playerImage.src = "/main/level1/speler.png";
...
const platforms = [
    {x: 0, y: canvas.height - 20, width: 200, height: 20, imageSrc: "/main/level1/platform.png"},
    {x: 150, y: canvas.height - 125, width: 200, height: 20, imageSrc: "/main/level1/platform.png" },
    {x: 0, y: canvas.height - 225, width: 200, height: 20, imageSrc: "/main/level1/platform.png"},
    {x: 300, y: canvas.height - 325, width: 200, height: 20, imageSrc: "/main/level1/platform.png"},
    {x: 300, y: canvas.height - 375, width: 50, height: 50, imageSrc: "/main/level1/draak.jpg" },// dit is de draak
    {x: 200, y: canvas.height - 20, width: canvas.width, height: 20, color: "rgba(0,0,0,0)" }, // dit is de dodezone
    {x: 0, y: canvas.height - 205, width: 170, height: 20, color: "red", imageSrc: "/main/level1/dood1.png" },// 2e dode zone
];
    ...
    platforms.forEach(platform => {
        if (
            ...
            if (platform.color === "red" || platform.color === "rgb(230, 229, 229)" || platform.color === "rgba(0,0,0,0)") {
                resetGame();
            } else if (platform.imageSrc === "/main/level1/draak.jpg") {
                window.location.href = "/main/level1/level2/index2.html"; // Laad index2.html als de speler het draak-platform aanraakt
            } else {
